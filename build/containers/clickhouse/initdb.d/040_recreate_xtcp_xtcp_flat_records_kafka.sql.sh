...
SQL_FILE="${DIR}sql/xtcp_xtcp_flat_records_kafka.sql";
#SQL_FILE="${DIR}sql/xtcp_xtcp_flat_records_kafka_testing.sql";
...
echo "${d}" > "${DIR}out/date_kafka";
echo "${du}" > "${DIR}out/date_utc_kafka";

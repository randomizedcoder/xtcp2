...
#ifndef clickhouse_5flist_2fv1_2fclickhouse_5fprotolist_2eproto_2epb_2eh
#define clickhouse_5flist_2fv1_2fclickhouse_5fprotolist_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_clickhouse_5flist_2fv1_2fclickhouse_5fprotolist_2eproto
...
struct TableStruct_clickhouse_5flist_2fv1_2fclickhouse_5fprotolist_2eproto {
...
/* @@protoc_insertion_point(class_definition:clickhouse_protolist.v1.Record) */ {
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_clickhouse_5flist_2fv1_2fclickhouse_5fprotolist_2eproto;
};
// -------------------------------------------------------------------
...
/* @@protoc_insertion_point(class_definition:clickhouse_protolist.v1.Envelope) */ {
 ...
 public:
  ...
  public:
  void clear_row() ;
  ::clickhouse_protolist::v1::Record* mutable_row(int index);
  ::google::protobuf::RepeatedPtrField<::clickhouse_protolist::v1::Record>* mutable_row();

  private:
  const ::google::protobuf::RepeatedPtrField<::clickhouse_protolist::v1::Record>& _internal_row() const;
  ::google::protobuf::RepeatedPtrField<::clickhouse_protolist::v1::Record>* _internal_mutable_row();
  public:
  const ::clickhouse_protolist::v1::Record& row(int index) const;
  ::clickhouse_protolist::v1::Record* add_row();
  const ::google::protobuf::RepeatedPtrField<::clickhouse_protolist::v1::Record>& row() const;
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::RepeatedPtrField< ::clickhouse_protolist::v1::Record > row_;
    ::google::protobuf::internal::CachedSize _cached_size_;
    PROTOBUF_TSAN_DECLARE_MEMBER
  };
  union { Impl_ _impl_; };
...
inline ::clickhouse_protolist::v1::Record* Envelope::mutable_row(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:clickhouse_protolist.v1.Envelope.row)
  return _internal_mutable_row()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField<::clickhouse_protolist::v1::Record>* Envelope::mutable_row()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:clickhouse_protolist.v1.Envelope.row)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_row();
}
inline const ::clickhouse_protolist::v1::Record& Envelope::row(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:clickhouse_protolist.v1.Envelope.row)
  return _internal_row().Get(index);
}
inline ::clickhouse_protolist::v1::Record* Envelope::add_row() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::clickhouse_protolist::v1::Record* _add = _internal_mutable_row()->Add();
  // @@protoc_insertion_point(field_add:clickhouse_protolist.v1.Envelope.row)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::clickhouse_protolist::v1::Record>& Envelope::row() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:clickhouse_protolist.v1.Envelope.row)
...
#endif  // clickhouse_5flist_2fv1_2fclickhouse_5fprotolist_2eproto_2epb_2eh

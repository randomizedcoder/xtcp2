...
class XtcpFlatRecord(_message.Message):
    ...
    NETNS_INODE_FIELD_NUMBER: _ClassVar[int]
    ...
    UPLINK1_IFNAME_FIELD_NUMBER: _ClassVar[int]
    UPLINK1_NIC_DRIVER_FIELD_NUMBER: _ClassVar[int]
    UPLINK1_NIC_MODEL_FIELD_NUMBER: _ClassVar[int]
    UPLINK1_NIC_PCI_VENDOR_FIELD_NUMBER: _ClassVar[int]
    UPLINK1_NIC_PCI_DEVICE_FIELD_NUMBER: _ClassVar[int]
    UPLINK1_NIC_BUS_INFO_FIELD_NUMBER: _ClassVar[int]
    UPLINK1_NIC_SPEED_MBPS_FIELD_NUMBER: _ClassVar[int]
    UPLINK1_NIC_FW_VERSION_FIELD_NUMBER: _ClassVar[int]
    UPLINK1_LLDP_CHASSIS_NAME_FIELD_NUMBER: _ClassVar[int]
    UPLINK1_LLDP_CHASSIS_ID_FIELD_NUMBER: _ClassVar[int]
    UPLINK1_LLDP_MGMT_IP_FIELD_NUMBER: _ClassVar[int]
    UPLINK1_LLDP_PORT_ID_FIELD_NUMBER: _ClassVar[int]
    UPLINK1_LLDP_PORT_DESCR_FIELD_NUMBER: _ClassVar[int]
    UPLINK2_IFNAME_FIELD_NUMBER: _ClassVar[int]
    UPLINK2_NIC_DRIVER_FIELD_NUMBER: _ClassVar[int]
    UPLINK2_NIC_MODEL_FIELD_NUMBER: _ClassVar[int]
    UPLINK2_NIC_PCI_VENDOR_FIELD_NUMBER: _ClassVar[int]
    UPLINK2_NIC_PCI_DEVICE_FIELD_NUMBER: _ClassVar[int]
    UPLINK2_NIC_BUS_INFO_FIELD_NUMBER: _ClassVar[int]
    UPLINK2_NIC_SPEED_MBPS_FIELD_NUMBER: _ClassVar[int]
    UPLINK2_NIC_FW_VERSION_FIELD_NUMBER: _ClassVar[int]
    UPLINK2_LLDP_CHASSIS_NAME_FIELD_NUMBER: _ClassVar[int]
    UPLINK2_LLDP_CHASSIS_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    netlinker_id: int
    uplink1_ifname: str
    uplink1_nic_driver: str
    uplink1_nic_model: str
    uplink1_nic_pci_vendor: int
    uplink1_nic_pci_device: int
    uplink1_nic_bus_info: str
    uplink1_nic_speed_mbps: int
    uplink1_nic_fw_version: str
    uplink1_lldp_chassis_name: str
    uplink1_lldp_chassis_id: str
    uplink1_lldp_mgmt_ip: str
    uplink1_lldp_port_id: str
    uplink1_lldp_port_descr: str
    uplink2_ifname: str
    uplink2_nic_driver: str
    uplink2_nic_model: str
    uplink2_nic_pci_vendor: int
    uplink2_nic_pci_device: int
    uplink2_nic_bus_info: str
    uplink2_nic_speed_mbps: int
    uplink2_nic_fw_version: str
    uplink2_lldp_chassis_name: str
    uplink2_lldp_chassis_id: str

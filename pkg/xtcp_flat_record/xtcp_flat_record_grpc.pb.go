...
func (UnimplementedXTCPFlatRecordServiceServer) FlatRecords(*FlatRecordsRequest, grpc.ServerStreamingServer[FlatRecordsResponse]) error {
	return status.Error(codes.Unimplemented, "method FlatRecords not implemented")
}
func (UnimplementedXTCPFlatRecordServiceServer) PollFlatRecords(grpc.BidiStreamingServer[PollFlatRecordsRequest, PollFlatRecordsResponse]) error {
	return status.Error(codes.Unimplemented, "method PollFlatRecords not implemented")
}
...
func RegisterXTCPFlatRecordServiceServer(s grpc.ServiceRegistrar, srv XTCPFlatRecordServiceServer) {
	// If the following call panics, it indicates UnimplementedXTCPFlatRecordServiceServer was
